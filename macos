...
sudo scutil --set ComputerName "Zell's Macbook"
sudo scutil --set HostName "Zell's Macbook"
sudo scutil --set LocalHostName "zells-macbook"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Zell's Macbook"
